...
function jobTracker(data, job, location) {
    const jobLower = job.toLowerCase()
    const locationLower = location.toLowerCase()

    const result = data.filter((item, index) => {
        if (item.title.toLowerCase().includes(jobLower) && item.location.toLowerCase().includes(locationLower)) {
...
const searchResult = jobTracker(jobs, "ENGINEER", "us")
